...
export default function IndexPage() {
  return (
    <div className="bg-gray-400">
      ...
      <Nav />
      <div>
        <h1 className="text-4xl mb-5 px-8 text-accent-1 font-mono">
          Plug&Play Components
        </h1>
        <ul className="text-xl ml-20 mb-10 leading-8 font-mono">
          <li className="flex items-center text-xl">
            <svg class="h-8 mr-3" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <linearGradient id="paint0_linear" x1="3.5" y1="16" x2="59" y2="48" gradientUnits="userSpaceOnUse"><stop stop-color="#2298BD">
                  </stop>
            ...
            <li className="flex text-xl ml-1 items-center"><span className="text-3xl mr-4">💸</span>Free to use</li>
            <li className="flex text-xl ml-1 items-center"><span className="text-3xl mr-3">💬</span>by <a href="https://twitter.com/timbislopez" className="text-blue-500 pl-3"> Ema Tim López</a></li>
        </ul>
